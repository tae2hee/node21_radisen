...
COPY --chown=algorithm:algorithm model.training /opt/algorithm/
COPY --chown=algorithm:algorithm model2_mil.training  /opt/algorithm/
...
COPY --chown=algorithm:algorithm process.py postprocessing.py preprocessing.py /opt/algorithm/
