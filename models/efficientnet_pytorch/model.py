...
#         if isinstance(self._fc, nn.Linear):
#             torch.nn.init.xavier_uniform(self._fc.weight)
# #             self._fc.weight.data.fill_(0.01)
#             self._fc.bias.data.fill_(0.01)
#             print(self._fc.weight)
